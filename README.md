...
You do not need a separate GitHub OAuth app. Entry Agent uses the GitHub App's OAuth credentials as a Better Auth social provider, plus the App's installation tokens for repo access.
