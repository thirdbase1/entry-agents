...
function LingIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 16 16" fill="none" {...props}>
      <circle cx="8" cy="8" r="6.6" stroke="#1677FF" strokeWidth="1.5" />
      <circle cx="8" cy="8" r="2.3" fill="#1677FF" />
    </svg>
  );
}
...
function Hy3Icon(props: IconProps) {
  return (
    <svg viewBox="0 0 16 16" fill="none" {...props}>
      <path
        fill="#7C5CFC"
        d="M8 .8 9.6 6l5.2.1-4.2 3.2 1.6 5.1L8 11.2l-4.2 3.2 1.6-5.1L1.2 6.1 6.4 6z"
      />
    </svg>
  );
}
