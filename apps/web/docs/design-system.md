...
This document defines the visual design system used across the Entry Agent web application, particularly for unauthenticated/marketing pages.

## Design Philosophy

The design follows a **dark terminal aesthetic** that reflects the developer-focused, CLI-centric nature of Entry Agent. The visual language communicates:
