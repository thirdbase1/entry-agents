...
ALTER TABLE "sessions" ADD COLUMN "auto_approve_tools_override" boolean;--> statement-breakpoint
ALTER TABLE "user_preferences" ADD COLUMN "auto_approve_tools" boolean DEFAULT false NOT NULL;